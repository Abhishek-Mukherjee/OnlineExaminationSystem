      ...
      <form class="login-form" action="login" method="post">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input class="validate" id="email" type="text" name="uname">
            <label for="email" data-error="wrong" data-success="right" class="center-align">User Name</label>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
        ...
        <div class="row">
          <div class="input-field col s6 m6 l6">
            <p class="margin medium-small"><a href="AdminSignup.jsp">Register Now!</a></p>
          </div>
