...
%>
	<fieldset>
			...
			<label>OPTION 2</label><input type="text" name="2opt<%= t %>" style="width: 250px;" value="<%=rs.getString(4) %>"></br></br>
			<label>OPTION 3</label><input type="text" name="3opt<%= t %>" style="width: 250px;" value="<%=rs.getString(4) %>"></br></br>
			<label>OPTION 4</label><input type="text" name="4opt<%= t %>" style="width: 250px;" value="<%=rs.getString(4) %>"></br></br>
			<select name="ans<%=t%>">
