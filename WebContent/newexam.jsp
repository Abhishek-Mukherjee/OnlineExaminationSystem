...
<div id="wrap">
  ...
  <div id="main">
    <div id="contact-details">
      ...
      <h4>Time: <span>[Please Enter Exam time IN SECOND for ex:- if you need 5 minute then multiply 5 with 60]</span></h4>
      <h4>Marks of each Questions: <span>[Each question's mark is important for result generate]</span></h4>
      <h4>Examination Date: <span>[Date format: date- month- year for ex:- 22-06-2021 ]</span></h4>
    </div>
    <!--end contact-details-->
...
if(request.getAttribute("name")!= null)
	out.println("<h3>"+request.getAttribute("name").toString()+"</h3>");
%>
  ...
  <!--end main-->
  <div id="footer">
    <p class="copyright">Copyright &copy; <a href="#">ASD SYSTEM</a> - All Rights Reserved / Design By Abhishek Mukherjee & Susmita Das <a target="_blank" href="http://www.chris-creed.com/">Chris Creed</a></p>
   </div>
  <!--end footer-->
</div>
<!--end wrap-->
